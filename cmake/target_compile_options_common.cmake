function(target_compile_options_common target scope)
    # Ensure that the 'scope' argument is one of the expected keywords
    if(NOT scope STREQUAL "INTERFACE"
        AND NOT scope STREQUAL "PUBLIC"
        AND NOT scope STREQUAL "PRIVATE")
        message(
            FATAL_ERROR
            "Invalid scope: ${scope}. Must be INTERFACE, PUBLIC, or PRIVATE.")
    endif()
    ...
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        set(COMPILE_OPTIONS
            ...
            # a non-virtual destructor. This helps catch hard to track down memory
            # errors
    ...
    target_compile_options(${target} ${scope} ${COMPILE_OPTIONS})
endfunction()
