...
# Class translotator::SquareMatrix

**template &lt;size\_t N, typename Type&gt;**



[**ClassList**](annotated.md) **>** [**translotator**](namespacetranslotator.md) **>** [**SquareMatrix**](classtranslotator_1_1SquareMatrix.md)
...
Inherited by the following classes: [translotator::SOGroup](classtranslotator_1_1SOGroup.md)
...
| Type | Name |
| ---: | :--- |
|  constexpr static ObjectType | [**OBJECT\_TYPE**](#variable-object_type)   = = ObjectType::SQUARE\_MATRIX<br> |
...
| Type | Name |
| ---: | :--- |
|  Type | [**determinant**](#function-determinant) () const<br>_determinant of a square matrix. Only 2x2, 3x3 matrices are supported_  |
|  void | [**inverse**](#function-inverse) () <br> |
|  [**SquareMatrix**](classtranslotator_1_1SquareMatrix.md)&lt; N, Type &gt; | [**inversed**](#function-inversed) (bool & result) const<br>_1x1 ~ 3x3 closed form solution 4x4 ~ LU factorization with partial pivotting from PX4-Matrix Library_  |
|  Type | [**trace**](#function-trace) () const<br>_trace of a square matrix_  |
...
```C++
constexpr static ObjectType translotator::SquareMatrix< N, Type >::OBJECT_TYPE;
```
...
```C++
inline Type translotator::SquareMatrix::determinant () const
```
...
```C++
inline void translotator::SquareMatrix::inverse () 
```
...
```C++
inline SquareMatrix < N, Type > translotator::SquareMatrix::inversed (
    bool & result
) const
```
...
```C++
inline Type translotator::SquareMatrix::trace () const
```
